...
class UpdateJob extends Component {
  ...
  render() {
    return (
      <div className="App">
        <Header title="职务" leftIcon='angle-left' leftIconAction={() => { returnBack(this.props) }} />
        <section className="contain">
            <div className="update">
                <input type="text" defaultValue={this.state.myInfo.job} onChange={(e)=>{
                  this.changeValue(e);
                }} />
            </div>
            {/* 提交按钮 start */}
